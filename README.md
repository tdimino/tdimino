# Tom di Mino ![GitHub followers](https://img.shields.io/github/followers/tdimino)

[![Portfolio](https://img.shields.io/badge/Portfolio-minoanmystery.org-966a85?style=flat&logo=astro)](https://www.minoanmystery.org)
...
AI/ML engineer building cognitive AI systems. Formerly at **Subquadratic** architecting search engines, golden datasets, and agentic harnesses for subquadratic-attention LLMs. Previously shipped AI tools at **JP Morgan Chase** serving 5,000+ wealth advisors. 

Officially deciphered Linear A (𐘭𐘯𐘇𐘴 · 𐘇).

## Projects

### [<img src="https://raw.githubusercontent.com/tdimino/tdimino/main/badges/minoanmystery.png" width="28" height="28" align="top">](https://raw.githubusercontent.com/tdimino/tdimino/main/badges/full/minoanmystery.png) [minoanmystery](https://github.com/tdimino/minoanmystery)
...
Open-source framework for imbuing Claude Code with a soul. Persistent yet evolving persona via `soul.md`, three-tier memory (working/user/global with SQLite), cognitive pipeline, and channel adapters for Slack, SMS, WhatsApp, and terminal.
...
Deciphering the Linear A corpus using computational and linguistic analysis. Exploring Minoan phonetic mappings via Cyrus H. Gordon's lexicon.
...
AI-native markdown previewer with annotations, bookmarks, and live reload. Zero dependencies. Named for the Semitic root D-B-R.
...
When not shipping production LLMs, I'm translating 3500 year old inscriptions, porting game engines to macOS, hiking, praying, or meditating in a sauna!
