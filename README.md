...
Open-source framework for imbuing Claude Code with a soul. Persistent personality via `soul.md`, three-tier memory (working/user/global with SQLite), cognitive pipeline, and channel adapters for Slack, SMS, WhatsApp, and terminal.
